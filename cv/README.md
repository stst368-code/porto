...
## v3 certificate drag fix
Desktop certificate frames are no longer anchor elements. They are draggable frame objects with manual click-to-open behaviour. Native browser link/file dragging is disabled, eliminating the PDF/file drag ghost.
