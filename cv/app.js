...
const PDF_URL = "CV_SimonTaylor.pdf";
...
const CERTIFICATES = [
  ...
  {
    id: "cmilt",
    file: "certs/CMILT.pdf",
    optional: true
  },
  {
    id: "ibmda",
    file: "certs/IBMDA.pdf",
    optional: false
  },
  {
    id: "googleda",
    file: "certs/GoogleDA.pdf",
    optional: false
  }
];
  ...
  .catch(error=>{
    ...
    pageGrid.innerHTML=`
      <div style="grid-column:1/-1;background:#fff;color:#222;padding:30px;border:1px solid #bbb;box-shadow:0 20px 45px rgba(0,0,0,.18)">
        ...
        <p>Place your PDF at <code>CV_SimonTaylor.pdf</code>, then refresh.</p>
      </div>`;
  });
